...
First, let's see which day has the most number of transactions and which category is the most used one (what is the money drainer!):
...
Well, good, but does not look nice.. So let's "paint it"
...
title ="Cash receipts/spending across categories",
subtitle = "per number of transactions")+
  theme(
...
cf%>%
  ...
  geom_col()+ 
  labs(x = "Categories", y = "Number of transactions",
title ="Cash receipts/spending across days of the week",
subtitle = "per number of transactions")+
  theme(
  panel.border = element_blank(),
  panel.grid.major = element_blank(),
...
cf%>%filter(credit_amount==0)%>%
  ...
  geom_col()+ 
  labs(x = "Days", y = "$ value",
title ="Cash receipts/spending across days",
subtitle = "$ value")+
  theme(
  panel.border = element_blank(),
  panel.grid.major = element_blank(),
